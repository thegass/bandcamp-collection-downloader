...
Download items from an existing Bandcamp account collection.
  ...
  --delay-requests-randomly
                            Add a random delay between requests to avoid being blocked (http error 429) by Bandcamp.
  --delay-requests-max=<delayRequestsMax>
                            Maximum delay in ms between requests (default: 2000).
  --delay-requests-min=<delayRequestsMin>
                            Minimum delay in ms between requests (default: 1000).
  ...
  --debug                   Print extra debug information, including the complete java stack trace on error.
....
